            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form id="formulario_eControl">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" name="actividades" rows="12"><?php echo $_POST['actividades'] ?></textarea>
                                    </div>
                                </div>
                                <br />
                                <div class="row">
                        ...
                        <input type="text" name="idAsesor" value="<?php echo $_POST['id_asesor'] ?>" hidden>
                        <div class="card">
