                ...
                <div class="container-fluid px-4">
                    ...
                    <form id="formulario_eControl">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="number" class="form-control" name="id" id="id" value="<?php echo $_POST['nit'] ?>" readonly>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <label>Módulo</laber>
                                            <select class="form-select" name="modulo">
                                                ...
                                                <?php while ($mod = $modulo->fetch_assoc()) { ?>
                                                    <option value="<?php echo $mod['id'] ?>" <?php if ($mod['id'] == $id_modulo) {
                                                                                                    echo ' selected="selected"';
                                                                                                } ?>><?php echo $mod['nombre'] ?></option>
                                                <?php } ?>
                                            </select>
                                    </div>
                                    <div class="col-6">
                                        <label>Servicio</laber>
                                            <select class="form-select" name="servicio">
                                                ...
                                                <?php while ($tipoS = $tipoServicio->fetch_assoc()) { ?>
                                                    <option value="<?php echo $tipoS['id']; ?>" <?php if ($tipoS['id'] == $id_servicio) {
                                                                                                    echo ' selected="selected"';
                                    ...
                                    <div class="col-6">
                                        <select class="form-select col-6" name="idTicket" required>
                                            ...
                                            <?php while ($ticket = $tarea->fetch_assoc()) { ?>
                                                <option value="<?php echo $ticket['id']; ?>" <?php if ($ticket['id'] == $_POST['id_ticket']) {
                                                                                                    echo ' selected="selected"';
                                                                                                } ?>><?php echo $ticket['nombre']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <button type="button" class="btn btn-primary" name="button" id="editarControl">Actualizar</button>
                        </div>
                    </form>
                </div>
            </main>
