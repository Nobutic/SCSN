...
<head>
    ...
    <title>Lista de Controles :: INSU TI</title>
                                        ...
                                        while ($dato = $servicio->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td style="text-align:center">
                                                    ...
                                                    <a type="button" class="btn btn-danger" aria-label="Eliminar" data-balloon-pos="up" href="../../controller/admin/eliminarControl.php?id=<?php echo $dato['id_servicio'] ?>" onclick="return Confirmation()"><i class="fa fa-trash-can"></i></a>
