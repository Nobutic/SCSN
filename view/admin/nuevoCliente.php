...
<head>
    ...
    <title>Nuevo Cliente :: INSU TI</title>
                ...
                <div class="container-fluid px-4">
                    ...
                    <form id="nuevocliente">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label>Nombre</label>
                                <input class="form-control" autocomplete="off" name="Nombre" type="text" value="" />
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" autocomplete="off" name="Id" type="number" maxlength="10" />
                            </div>

                            <div class="col-md-6">
                                <label>Email</label>
                                <input class="form-control" autocomplete="off" name="email" type="email" />
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" autocomplete="off" name="direccion" type="text" />
                            </div>
                            <div class="col-md-6">
                                <label>Telefono</label>
                                <input class="form-control" autocomplete="off" name="telefono" type="number" />
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label>Ciudad</label>
                                <input class="form-control" autocomplete="off" name="ciudad" type="text" />
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" autocomplete="off" name="nombreContacto" type="text" />
                            </div>

                            <div class="col-md-6">
                                <label>Cargo</label>
                                <input class="form-control" autocomplete="off" name="cargo" type="text" />
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label>Celular</label>
                                <input class="form-control" autocomplete="off" name="celular" type="text" />
                            </div>

                            <div class="col-md-6">
                                <label>Email</label>
                                <input class="form-control" autocomplete="off" name="emailContacto" type="text" />
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" autocomplete="off" name="nameUser" type="text" />
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="col-12">
                            ...
                            <button type="button" class="btn btn-primary" name="button" id="registrarCliente">Registrar</button>
                        </div>
                    </form>
                </div>
            </main>
