            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple" class="table table-sm table-bordere">
                                <thead>
                                    <tr>
                                        <th># Servicio</th>
                                        <th>Cliente</th>
                                    ...
                                    <?php while ($tarea = $tareas->fetch_assoc()) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($tarea['estado'] == 'RESUELTO') {
                                                ...
                                                echo '<td class="text-center"><span class="badge badge-pill badge-warning">' . $tarea["estado"] . '</span></td>';
                                            } ?>
                                            <td>
                                                <button type="button" class="btn btn-success" aria-label="Ver Detalle" data-balloon-pos="up" data-bs-toggle="modal" data-bs-target="#uni_modal<?php echo $tarea['id_servicio'] ?>"><i class="fa fa-eye"></i></button>
                                            </td>
                                        </tr>
