...
<body class="sb-nav-fixed"><?php include_once('modalClave.php'); ?>
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <button class="btn btn-primary me-md-2" data-bs-toggle="modal" data-bs-target="#tAgregar">Nuevo Ticket</button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <table id="datatablesSimple" class="table table-sm table-striped table-bordere" class="display">
                                        ...
                                        <tbody>
                                            <?php while ($t = $ticket->fetch_assoc()) { ?>
                                                <tr>
                                                    <td><?php echo $t['id'] ?></td>
    ...
    <div class="modal fade" id="tAgregar" tabindex="-1" aria-labelledby="exampleModalLabel" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="../../controller/admin/registroTicket.php">
