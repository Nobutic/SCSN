...
$objeto = new Servicio();
$tipoServicio = $objeto->listarTipoServicio();
...
<head>
    ...
    <title>Tipo de servicio :: INSU TI</title>
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <button class="btn btn-primary me-md-2" data-bs-toggle="modal" data-bs-target="#tSAgregar">Nuevo Tipo de servicio</button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <table id="tableTipoServicio" class="table table-sm table-striped table-bordere">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Nombre</th>
                                        ...
                                        <tbody>
                                            <?php while ($tServicio = $tipoServicio->fetch_assoc()) { ?>
                                                <tr>
                                                    <td><?php echo $tServicio['id'] ?></td>
                                                    <td><?php echo $tServicio['nombre'] ?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
