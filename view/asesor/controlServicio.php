                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" name="consecutivo" value="<?php echo $fechaActual ?>" hidden>
                            </div>
                        </div>
                        <br/>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <label>Tiempo de asesoria(En minutos)</label>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="actividades" rows="15" maxlength="2000"></textarea>
                            </div>
                        </div>
                        <br/>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <textarea class="form-control" name="pAsesor" rows="15" maxlength="1200" placeholder="Detallar las actividades pendientes "></textarea>
                            </div>
                        </div>
                        <br/>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="pCliente" rows="8" maxlength="1200"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
