            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <div class="row">
                            <div class="col-md-12">
                                <h3>Mi Historial de Servicios <i class="fa fa-gears"></i></h3>
                                <hr/>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12 text-center mt-5">
                                <form action="descargarReporte.php" method="post">
                                    <div class="row">
                                        ...
                                        <input type="text" name="idCliente" id="idCliente" value="<?php echo ucfirst($_SESSION['id']); ?>" hidden>
        ...
        <script type="text/javascript">
            ...
            $("#filtro").on("click", function(e){
                ...
                if(mes !="" && anio !="" && idCliente !=""){
                    $.post("filtroServicio.php", {mes, anio, idCliente}, 
                    function (data) {
                        $("#tableControl").hide();
